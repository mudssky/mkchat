      ...
      <div className="flex flex-1 flex-col">
        ...
        <main className="flex-1 px-6 py-8">
          <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
            <section className="relative overflow-hidden rounded-[32px] border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <section className="grid gap-6 md:grid-cols-3">
              {[
                {
                  title: "清晰的协作结构",
                  description: "用树状分支管理上下文，让每条探索路径都可追踪。",
                  icon: Workflow,
                },
                {
                  title: "模型与工具解耦",
                ...
                <div
                  key={feature.title}
                  className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900"
                >
            ...
            <section className="grid gap-6 md:grid-cols-[1.2fr_1fr]">
              ...
              <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                ...
                <div className="mt-4 flex flex-col gap-3">
                  ...
                  >
                    模型提供商
                    <span className="text-xs text-zinc-400">绑定 API Key</span>
                  </Link>
                </div>
              </div>
            </section>
